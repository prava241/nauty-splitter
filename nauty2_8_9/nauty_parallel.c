...
// static splitter_short_t *firstcode_splitter; /* First path refinement codes -- should not be a hyperobject because firstpathnode will be executed serially */
// static splitter_short_t *canoncode_splitter; /* Canonical refinement codes -- should be a reducer */
// static splitter_int_t *firsttc_splitter; /* First path target cells */

// /* Global options */
// static boolean getcanon, digraph, domarkers, doschreier; /*turn off doschrier*/
